...
public class Game {
	...
	public void play() {
	    ...
	    while (snake.isInbounds()) { //keeps running game as long as snake in bounds
	        int dir = getKeypress();
	        if (dir != -1) {
	        ...
	        if (snake.eatFood(food)) { //check if the snake ate the food (T or F)
	    ...
	    showGameOverScreen(); //if snake out of bounds show end screen
	}
			/*
